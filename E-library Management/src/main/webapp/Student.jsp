...
<body>
	...
	<div class="container">
		<div class="row row-cols-6 g-4">
			<div class="col text-center">
				<div class="card">
					<img src="images/library.png" class="card-img-top" alt="" />
					<div class="card-body">
			...
			<div class="col text-center">
				<div class="card">
					<img src="images/return.png" class="card-img-top"
						alt="Palm Springs Road" />
					<div class="card-body">
						<a href="returnbook.jsp" class="btn btn-primary">Return Book</a>
					</div>
				</div>
			</div>
			<div class="col text-center">
				<div class="card">
					<img src="images/request.png" class="card-img-top"
						alt="Palm Springs Road" />
					<div class="card-body">
						<a href="requestbook.jsp" class="btn btn-primary">Request Book</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="video1">
		<video style="width:540px; object-fit: cover;" autoplay loop muted>
			<source src="images/library quotes.mp4"
				type="video/mp4" />
		</video>
	</div>
