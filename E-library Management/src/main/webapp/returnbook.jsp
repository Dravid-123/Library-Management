...
<div class="container">
<p class="note"><b style="color:red;">Important note : </b>Return books on time or pay a 5 rupee per day late fee.</p>
...
<td><a class="btn btn-primary fs-6" href="returnbookform.jsp?bookid=<%=resultSet.getString("bookid")%>">Return</a></td>
</tr>
</tbody>
<%
}
...
var daysOverdue = (returnDateObject - dueDateObject) / (1000 * 60 * 60 * 24);
var finePerDay = 0.50;
var totalFine = daysOverdue * finePerDay;
document.getElementById("fineAmount").innerHTML = totalFine.toFixed(2);
</script>
</body>
</html>